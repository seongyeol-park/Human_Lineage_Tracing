...
while line:
	if line[0:6]=='#CHROM':
		...
		wt_count1=int(line_split[5].split(';')[0])
		var_count1=int(line_split[5].split(';')[1])
		if line_split[6]=='.' or line_split[6]=='NA':
			info_list=['.','.','.']
		else:
			seqztCN1=int(line_split[6])
			seqzmCN1=int(line_split[8])
